...
int16_t chess_storage(%chess_alignof(v16int16))buffer_aie_in[NUM_INPUT_WORDS + AIE_POINTER_ADJUST];
int16_t chess_storage(%chess_alignof(v8int16))buffer_aie_out[NUM_OUTPUT_WORDS];
...
int main()
	...
	fir_sym_8t_16x16real(get_input_window_int16(&aie_input), get_output_window_int16(&aie_output));
